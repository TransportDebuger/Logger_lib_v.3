 ...
 *
 * - **v2.1** (2025-12-15): Улучшена документация `isEnabled()`, устранено
 * дублирование `@ingroup`
 * - **v2.0** (2025-12-14): Полная рефакторизация интерфейса, удалены
 * реализации, добавлены `[[nodiscard]]` и `noexcept`
...
class ILogger {
 public:
   ...
   * @note Результат помечен [[nodiscard]] — игнорирование вызовет
